...
function CurrentPosition() {
  ...
  // 🔹 NEW: always a fresh conversationId on mount
  ...
  const handleProceed = () => {
    const summaryMessage = messages
      .find((m) => m.text.includes("__SUMMARY_COMPLETE__"))
      ?.text.replace("__SUMMARY_COMPLETE__", "")
      .trim();
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="flex items-end gap-3 pt-2">
            ...
            <button
              type="button"
              onClick={handleSend}
              className="inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-cyan-500 to-blue-500 px-4 py-2 text-sm md:text-base font-semibold text-white shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 hover:scale-105 transition-transform transition-shadow duration-200"
            >
              Send
            </button>
          </div>
        ...
        <div className="px-6 pb-12" ref={proceedRef}>
          <div className="max-w-4xl mx-auto flex justify-center">
            <button
              ...
              className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-purple-500 to-cyan-500 px-6 py-3 text-sm md:text-base font-semibold text-white shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 animate-pulse"
            >
